...
import { IqacData } from '@/app/(Private Pages)/actions/statutory-committees';
...
export default function IqacView({ data }: { data: IqacData }) {
	const { about, objectives, functions, committeeMembers, initiatives, aqar } =
		data;

		...
		<footer className='relative bg-gradient-to-br from-black via-gray-900 to-black text-white overflow-hidden'>
			...
			<style jsx>{`
				.stars {
					...
					box-shadow: 1541px 1046px #fff, 1651px 1164px #fff, 1286px 1642px #fff,
						1364px 1218px #fff, 1739px 1665px #fff, 1686px 1617px #fff,
						1853px 1341px #fff, 1388px 1567px #fff, 1123px 1253px #fff,
						1851px 1238px #fff, 1695px 1449px #fff, 1731px 1868px #fff,
						1251px 1732px #fff, 1441px 1409px #fff, 1532px 1352px #fff,
						1796px 1895px #fff, 1169px 1863px #fff, 1463px 1717px #fff,
						1689px 1894px #fff, 1755px 1279px #fff, 1394px 1516px #fff,
						1442px 1565px #fff, 1824px 1341px #fff, 1745px 1750px #fff,
						1318px 1317px #fff, 1892px 1643px #fff, 1165px 1579px #fff,
						1693px 1847px #fff, 1425px 1243px #fff, 1583px 1689px #fff,
						1754px 1594px #fff, 1689px 1423px #fff, 1496px 1267px #fff,
						1762px 1533px #fff, 1324px 1567px #fff, 1894px 1743px #fff,
						1167px 1342px #fff, 1845px 1478px #fff, 1634px 1847px #fff,
						1583px 1294px #fff, 1759px 1867px #fff, 1892px 1569px #fff,
						1325px 1794px #fff, 1567px 1432px #fff, 1472px 1673px #fff,
						1794px 1264px #fff, 1869px 1892px #fff, 1623px 1567px #fff,
						1345px 1789px #fff, 1892px 1345px #fff, 1567px 1892px #fff,
						1234px 1567px #fff, 987px 1456px #fff, 1678px 987px #fff,
						1234px 1678px #fff, 1456px 1234px #fff, 789px 1567px #fff,
						1890px 789px #fff, 1123px 1890px #fff, 1567px 1123px #fff,
						654px 1789px #fff, 1987px 654px #fff, 1345px 1987px #fff,
						1789px 1345px #fff, 432px 1654px #fff, 1876px 432px #fff,
						1098px 1876px #fff, 1654px 1098px #fff, 321px 1543px #fff,
						1765px 321px #fff, 1209px 1765px #fff, 1543px 1209px #fff,
						876px 1321px #fff, 1654px 876px #fff, 1432px 1654px #fff,
						1321px 1432px #fff, 543px 1876px #fff, 1987px 543px #fff,
						1765px 1987px #fff, 1876px 1765px #fff, 210px 1432px #fff,
						1543px 210px #fff, 1876px 1543px #fff, 1432px 1876px #fff;
				...
				.stars2 {
					...
					height: 2px;
					background: transparent;
					box-shadow: 700px 400px #fff, 400px 500px #fff, 300px 300px #fff,
						800px 200px #fff, 200px 600px #fff, 900px 700px #fff,
						100px 100px #fff, 600px 800px #fff, 500px 200px #fff,
						1000px 600px #fff, 150px 750px #fff, 850px 150px #fff,
						750px 550px #fff, 350px 850px #fff, 950px 350px #fff,
						250px 250px #fff, 650px 650px #fff, 450px 450px #fff,
						1100px 300px #fff, 300px 1100px #fff, 1200px 800px #fff,
						800px 1200px #fff, 1300px 500px #fff, 500px 1300px #fff,
						1400px 200px #fff, 200px 1400px #fff, 1500px 700px #fff,
						700px 1500px #fff, 1600px 400px #fff, 400px 1600px #fff,
						1700px 900px #fff, 900px 1700px #fff, 1800px 300px #fff,
						300px 1800px #fff, 1900px 600px #fff, 600px 1900px #fff,
						50px 450px #fff, 450px 50px #fff, 550px 950px #fff, 950px 550px #fff,
						1050px 250px #fff, 250px 1050px #fff, 1150px 750px #fff,
						750px 1150px #fff, 1250px 450px #fff, 450px 1250px #fff,
						1350px 850px #fff, 850px 1350px #fff, 1450px 150px #fff,
						150px 1450px #fff, 1550px 650px #fff, 650px 1550px #fff,
						1650px 350px #fff, 350px 1650px #fff, 1750px 750px #fff,
						750px 1750px #fff, 1850px 250px #fff, 250px 1850px #fff,
						1950px 550px #fff, 550px 1950px #fff;
				...
				.stars3 {
					...
					height: 3px;
					background: transparent;
					box-shadow: 600px 300px #fff, 300px 600px #fff, 900px 900px #fff,
						1200px 200px #fff, 200px 1200px #fff, 1500px 500px #fff,
						500px 1500px #fff, 800px 800px #fff, 1000px 400px #fff,
						400px 1000px #fff, 1300px 700px #fff, 700px 1300px #fff,
						100px 900px #fff, 900px 100px #fff, 1400px 600px #fff,
						600px 1400px #fff, 1600px 800px #fff, 800px 1600px #fff,
						1700px 300px #fff, 300px 1700px #fff, 1800px 700px #fff,
						700px 1800px #fff, 1900px 400px #fff, 400px 1900px #fff,
						50px 800px #fff, 800px 50px #fff, 1050px 500px #fff,
						500px 1050px #fff, 1150px 900px #fff, 900px 1150px #fff,
						1250px 200px #fff, 200px 1250px #fff, 1350px 600px #fff,
						600px 1350px #fff, 1450px 1000px #fff, 1000px 1450px #fff,
						1550px 300px #fff, 300px 1550px #fff, 1650px 700px #fff,
						700px 1650px #fff, 1750px 100px #fff, 100px 1750px #fff,
						1850px 500px #fff, 500px 1850px #fff, 1950px 900px #fff,
						900px 1950px #fff, 150px 1100px #fff, 1100px 150px #fff,
						250px 1300px #fff, 1300px 250px #fff, 350px 1500px #fff,
						1500px 350px #fff, 450px 1700px #fff, 1700px 450px #fff,
						550px 1900px #fff, 1900px 550px #fff;
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full'>
					...
					<motion.div
						...
						<div className='h-full flex flex-col items-center'>
							<h3 className='font-bold mb-4 sm:mb-6 text-white text-center text-xl sm:text-2xl lg:text-3xl'>
								Gallery
							</h3>
					...
					<motion.div
						...
						<div className='h-full flex flex-col items-center justify-center text-center'>
							<h3 className='font-bold mb-4 sm:mb-6 text-white text-xl sm:text-2xl lg:text-3xl'>
								Services
							</h3>
					...
					<motion.div
						...
						<div className='h-full flex flex-col items-center justify-center text-center'>
							{' '}
							{/* Added justify-center and text-center */}
							<h3 className='font-bold mb-4 sm:mb-6 text-white text-xl sm:text-2xl lg:text-3xl'>
								Contact Us
							</h3>
							<div className='space-y-3 flex-grow w-full'>
				...
				<motion.div
					...
					<div className='flex flex-col sm:flex-row items-center justify-between gap-6'>
						<div className='text-center sm:text-left'>
							<h4 className='font-semibold mb-2 text-white text-xl sm:text-2xl'>
								Connect With Us
							</h4>
				...
				<motion.div
					...
					<div className='text-center text-white relative z-10'>
						<p className='font-medium text-base'>
							© {new Date().getFullYear()} All Rights Reserved | BPIT | Powered
							By BPIT
						</p>
					</div>
				</motion.div>

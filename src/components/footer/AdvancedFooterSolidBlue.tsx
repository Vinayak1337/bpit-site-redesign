...
export default function AdvancedFooterSolidBlue() {
	...
	return (
		<footer className='relative bg-black/90 text-white overflow-hidden'>
			{' '}
			{/* Changed background to solid blue */}
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full'>
					...
					<motion.div
						...
						<div className='h-full flex flex-col items-center'>
							...
							<div className='grid grid-cols-2 gap-3 p-4 bg-gray-700/10 rounded-lg border border-white/10 flex-grow'>
								{' '}
								{/* Adjusted background color for consistency */}
								{galleryImages.map((image, index) => (
									<motion.div
										...
										<div className='relative overflow-hidden rounded-lg bg-black/50 ring-1 ring-white/20 group-hover:ring-white/40 transition-all duration-300 h-full'>
											{' '}
											{/* Adjusted background color for consistency */}
											<Image

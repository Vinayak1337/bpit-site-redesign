...
export const whyBpitFinalCta = {
  title: 'Ready to join BPIT?',
  subtitle: 'Join thousands of successful engineers who started their journey at BPIT',
  ctas: [

...
import { founderTributeData } from '@/data/about';

interface FounderTributeData {
...
const FounderTribute = ({ data }: { data: FounderTributeData }) => {
  return (
    <motion.div
...
export default function FounderTributePage() {
  return <FounderTribute data={founderTributeData} />;
}

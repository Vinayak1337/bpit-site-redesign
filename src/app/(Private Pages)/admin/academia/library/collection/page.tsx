...
import {
	...
	updateHero,
	updateContent
} from '@/app/(Private Pages)/actions/academia-library-collection';
...
export default async function Page() {
	...
	return (
		<div className='space-y-8'>
			<div>
				<h1 className='text-2xl font-bold text-gray-900 mb-2'>Book Collection</h1>
				<p className='text-gray-600'>Click any section to edit it.</p>
			</div>
			<SubHeroEditor initialData={hero} slug='collection' updateAction={updateHero} />

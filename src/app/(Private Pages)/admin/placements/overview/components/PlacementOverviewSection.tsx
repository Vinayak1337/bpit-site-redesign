				...
				<div className="container mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
						{data.teamMembers.map((member, index) => (
							...
							>
								<div className={`w-24 h-24 bg-gradient-to-r ${member.gradientColor} rounded-full mx-auto mb-6 flex items-center justify-center text-white text-2xl font-bold`}>
									{member.initials}
								</div>

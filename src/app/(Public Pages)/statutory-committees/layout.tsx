...
import StatutoryCommitteesHero from '@/app/(Public Pages)/statutory-committees/components/StatutoryCommitteesHero';
import DynamicSidebar from '@/components/ui/DynamicSidebar';
import StatutoryCommitteesContentWrapper from '@/app/(Public Pages)/statutory-committees/components/StatutoryCommitteesContentWrapper';

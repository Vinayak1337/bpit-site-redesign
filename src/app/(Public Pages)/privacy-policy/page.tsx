...
import { getPrivacyPolicyData } from '@/app/(Private Pages)/actions/privacy-policy';
import { PRIVACY_POLICY_PAGE_SLUG } from '@/lib/page-slugs';
...
export default async function PrivacyPolicyPage() {
	const { lastUpdated, intro, sections } = await getPrivacyPolicyData(PRIVACY_POLICY_PAGE_SLUG);

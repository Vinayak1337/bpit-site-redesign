...
export default function VisionMissionSection({ data }: Props) {
	return (
		<div className='space-y-6 sm:space-y-8'>
			<VisionHeroBlock data={data} />

			<VisionStatementBlock data={data} />

			<VisionPillarsBlock data={data} />

			<VisionAspirationsBlock data={data} />
		</div>
	);
}

export function VisionHeroBlock({ data }: Props) {
	return (
		<motion.div
...
export function VisionStatementBlock({ data }: Props) {
	return (
		<motion.div
			initial={{ opacity: 0, y: 20 }}
			animate={{ opacity: 1, y: 0 }}
...
export function VisionPillarsBlock({ data }: Props) {
...
export function VisionAspirationsBlock({ data }: Props) {
	if (data.aspirations.length === 0) return null;

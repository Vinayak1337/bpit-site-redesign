    ...
    const departments: Department[] = [
        {
            ...
            description: 'Cutting-edge computer science education with focus on software development, algorithms, AI, and emerging technologies.',
            ...
            faculty: 35,
            labs: 12,
            specializations: ['Artificial Intelligence', 'Machine Learning', 'Software Engineering', 'Cybersecurity']
        },
        {
            id: 'it',
            name: 'IT',
            fullName: 'Information Technology',
            description: 'Comprehensive IT education focusing on system administration, network management, and enterprise solutions.',
            ...
            faculty: 28,
            labs: 10,
            specializations: ['Network Administration', 'Database Management', 'Cloud Computing', 'IT Security']
        },
        {
            id: 'ece',
            name: 'ECE',
            fullName: 'Electronics & Communication Engineering',
            description: 'Advanced electronics and communication systems with emphasis on digital signal processing and telecommunications.',
        ...
        },
        {
            ...
            description: 'Comprehensive electrical engineering program covering power systems, control systems, and renewable energy.',
        ...
        },
        {
            ...
            description: 'Comprehensive business administration program with focus on leadership, strategy, and entrepreneurship.',

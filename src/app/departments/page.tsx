    ...
    const departments: Department[] = [
        {
            ...
            description: 'Cutting-edge computer science education with focus on artificial intelligence, machine learning, software engineering, and emerging technologies like blockchain and IoT.',
            ...
            faculty: 32,
            labs: 12,
            specializations: ['Artificial Intelligence', 'Machine Learning', 'Software Engineering', 'Data Science']
        },
        {
            id: 'it',
            name: 'IT',
            fullName: 'Information Technology',
            description: 'Comprehensive IT education focusing on software development, system administration, database management, and emerging technologies like cloud computing and cybersecurity.',
            ...
            faculty: 24,
            labs: 8,
            specializations: ['Software Development', 'Database Management', 'Cloud Computing', 'Cybersecurity']
        },
        {
            id: 'ece',
            name: 'ECE',
            fullName: 'Electronics & Communication Engineering',
            description: 'Advanced electronics and communication engineering with focus on VLSI design, embedded systems, digital signal processing, and wireless communication technologies.',
            ...
            faculty: 26,
            labs: 10,
            specializations: ['VLSI Design', 'Embedded Systems', 'Digital Signal Processing', 'Wireless Communication']
        },
        {
            id: 'eee',
            name: 'EEE',
            fullName: 'Electrical & Electronics Engineering',
            description: 'Comprehensive electrical engineering program covering power systems, control automation, renewable energy technologies, and smart grid systems.',
            ...
            faculty: 22,
            labs: 8,
            specializations: ['Power Systems', 'Control & Automation', 'Renewable Energy', 'Smart Grid Technology']
        },
        {
            id: 'mba',
            name: 'MBA',
            fullName: 'Master of Business Administration',
            description: 'Advanced business administration program focusing on strategic management, leadership development, digital marketing, and entrepreneurship for emerging business leaders.',
            ...
            faculty: 16,
            labs: 3,
            specializations: ['Strategic Management', 'Digital Marketing', 'Financial Management', 'Entrepreneurship']
        },
        {
            id: 'bba',
            name: 'BBA',
            fullName: 'Bachelor of Business Administration',
            description: 'Comprehensive undergraduate business program emphasizing practical management skills, digital business strategies, and entrepreneurial mindset development.',
            ...
            faculty: 20,
            labs: 2,
            specializations: ['Business Analytics', 'Digital Marketing', 'Financial Planning', 'International Business']
        }
    ];

	...
	const highlights = [
		{
			...
			description: 'Our students secured 1st place in National IEEE Circuit Design Competition with innovative VLSI solution.',
		...
		{
			title: 'Communication Systems Research Award',
			image: '/events/img2.png',
			description: 'Department recognized for outstanding research contribution in 5G Communication and Signal Processing.',
			category: 'Research',
			date: 'November 2024',
			achievement: 'Excellence Award',
			bgColor: 'from-green-500 to-green-600',
			participants: '12 Research Papers',
			prize: 'National Recognition'
		},
		{
			title: 'Electronics Expo 2024',
			image: '/events/img3.png',
			description: 'Annual electronics expo with 400+ participants and industry experts from semiconductor companies.',
			category: 'Event',
			date: 'October 2024',
		...
		{
			title: 'Semiconductor Industry Partnership',
			image: '/events/img1.png',
			description: 'Strategic collaboration with leading semiconductor companies for student internships and placements.',
		...
		{
			title: 'VLSI Design Contest Victory',
			image: '/events/img2.png',
			description: 'Team CircuitMasters won inter-college VLSI design contest with innovative microprocessor architecture.',
			category: 'Competition',
			date: 'August 2024',
		...
		{
			title: 'RF & Microwave Lab Launch',
			image: '/events/img3.png',
			description: 'New RF & Microwave engineering lab inaugurated with advanced antenna design and testing equipment.',
		...
		{
			title: 'Embedded Systems Project Showcase',
			image: '/events/img1.png',
			description: 'Students showcased innovative embedded systems projects with IoT integration and real-world applications.',
			category: 'Community',
			date: 'June 2024',
			achievement: 'Innovation Awards',
			bgColor: 'from-teal-500 to-teal-600',
			participants: '60+ Projects',
			prize: 'Recognition'
		},
		{
			title: 'Digital Signal Processing Workshop',
			image: '/events/img2.png',
			description: 'Comprehensive workshop series on Digital Signal Processing and Communication Systems for students.',
			category: 'Workshop',
			date: 'May 2024',
	...
	const students = [
		{
			...
			name: 'Arjun Sharma',
			image: '/events/img1.png',
			achievement: 'VLSI Design Engineer at Intel',
			year: '2023 Graduate',
			company: 'Intel',
			package: '₹42 LPA',
			location: 'Bangalore',
			description: 'Secured position as VLSI Design Engineer at Intel after excelling in digital circuit design and semiconductor technologies.',
			skills: ['Verilog', 'VHDL', 'VLSI Design', 'Digital Signal Processing'],
			projects: ['32-bit Microprocessor Design', '5G Communication System'],
			awards: ['Best Final Year Project', 'IEEE Circuit Design Competition Winner']
		},
		{
			id: 2,
			name: 'Priya Patel',
			image: '/events/img2.png',
			achievement: 'RF Engineer at Qualcomm',
			year: '2023 Graduate',
			company: 'Qualcomm',
			package: '₹38 LPA',
			location: 'Hyderabad',
			description: 'Landed RF Engineer role at Qualcomm with expertise in antenna design and wireless communication systems.',
			skills: ['RF Design', 'Antenna Engineering', '5G Technology', 'Microwave Systems'],
			projects: ['Smart Antenna Array Design', '5G Base Station Controller'],
			awards: ['Outstanding Leadership Award', 'Qualcomm Innovation Fellowship']
		},
		{
			id: 3,
			name: 'Rahul Kumar',
			image: '/events/img3.png',
			achievement: 'Senior Hardware Engineer at NVIDIA',
			year: '2022 Graduate',
			company: 'NVIDIA',
			package: '₹45 LPA',
			location: 'Santa Clara, USA',
			description: 'Promoted to Senior Hardware Engineer at NVIDIA within 1 year, leading GPU architecture projects and chip design.',
			skills: ['GPU Architecture', 'Digital Design', 'SystemVerilog', 'Computer Architecture'],
			projects: ['Next-Gen GPU Architecture', 'Graphics Processing Unit Design'],
			awards: ['NVIDIA Innovation Award', 'Best Design Excellence']
		},
		{
			id: 4,
			name: 'Sneha Gupta',
			image: '/events/img1.png',
			achievement: 'IoT Startup Founder',
			year: '2022 Graduate',
			company: 'SmartTech Solutions',
			package: 'Entrepreneur',
			location: 'Mumbai',
			description: 'Founded successful IoT startup that has deployed 50,000+ smart devices with innovative embedded solutions.',
			skills: ['Entrepreneurship', 'Embedded Systems', 'IoT Architecture', 'Team Leadership'],
			projects: ['Smart City Infrastructure', 'Industrial Automation System'],
			awards: ['Young Entrepreneur Award', 'Best Tech Startup Pitch']
		},
		{
			id: 5,
			name: 'Vikash Singh',
			image: '/events/img2.png',
			achievement: 'Signal Processing Engineer at Broadcom',
			year: '2023 Graduate',
			company: 'Broadcom',
			package: '₹48 LPA',
			location: 'San Jose, USA',
			description: 'Joined Broadcom as Signal Processing Engineer focusing on 5G baseband processing and communication algorithms.',
			skills: ['Digital Signal Processing', '5G Technology', 'MATLAB', 'Communication Systems'],
			projects: ['5G Baseband Processor', 'Advanced Modulation Schemes'],
			awards: ['Best Final Year Project', 'IEEE Signal Processing Society Award']
		},
		{
			id: 6,
			name: 'Ananya Gupta',
			image: '/events/img3.png',
			achievement: 'Embedded Systems Engineer at Tesla',
			year: '2023 Graduate',
			company: 'Tesla',
			package: '₹46 LPA',
			location: 'Austin, USA',
			description: 'Secured position as Embedded Systems Engineer at Tesla, working on battery management systems and electric vehicle control units.',
			skills: ['Embedded C/C++', 'Real-time Systems', 'Power Electronics', 'Automotive ECU'],
			projects: ['Battery Management System', 'Motor Control Unit'],
			awards: ['Tesla Innovation Award', 'Best Embedded Systems Project']
		},
		{
			id: 7,
			name: 'Karan Mehta',
			image: '/events/img1.png',
			achievement: 'Principal Engineer at Cisco',
			year: '2022 Graduate',
			company: 'Cisco',
			package: '₹44 LPA',
			location: 'San Jose, USA',
			description: 'Promoted to Principal Engineer at Cisco, leading the development of next-gen networking hardware and 5G infrastructure.',
			skills: ['Network Protocols', '5G Technology', 'Hardware Design', 'System Architecture'],
			projects: ['5G Base Station Design', 'Network Switching Hardware'],
			awards: ['Cisco Innovation Award', 'Best Network Architecture Design']
		},
		{
			id: 8,
			name: 'Ritika Sharma',
			image: '/events/img2.png',
			achievement: 'Analog IC Design Engineer at Analog Devices',
			year: '2023 Graduate',
			company: 'Analog Devices',
			package: '₹41 LPA',
			location: 'Wilmington, USA',
			description: 'Joined Analog Devices as IC Design Engineer working on high-performance analog circuits and mixed-signal systems.',
			skills: ['Analog IC Design', 'SPICE Simulation', 'Layout Design', 'Mixed-Signal Systems'],
			projects: ['High-Speed ADC Design', 'Low-Power Amplifier Circuit'],
			awards: ['Analog Devices Excellence Award', 'Outstanding Circuit Design']
		},
		{
			id: 9,
			name: 'Aditya Raj',
			image: '/events/img3.png',
			achievement: 'Hardware Engineer at SpaceX',
			year: '2022 Graduate',
			company: 'SpaceX',
			package: '₹52 LPA',
			location: 'Hawthorne, USA',
			description: 'Working as Hardware Engineer at SpaceX, developing satellite communication systems and avionics for space missions.',
			skills: ['Satellite Communication', 'RF Systems', 'Avionics', 'Space-grade Electronics'],
			projects: ['Starlink Satellite Transceiver', 'Rocket Avionics System'],
			awards: ['SpaceX Innovation Excellence', 'Best Aerospace Electronics Project']
		},
		{
			id: 10,
			name: 'Pooja Verma',
			image: '/events/img1.png',
			achievement: 'Senior Hardware Engineer at AMD',
			year: '2021 Graduate',
			company: 'AMD',
			package: '₹46 LPA',
			location: 'Austin, USA',
			description: 'Promoted to Senior Hardware Engineer at AMD, leading the development of next-gen processor architectures and chip design.',
			skills: ['Computer Architecture', 'Digital Design', 'RTL Design', 'Performance Analysis'],
			projects: ['Next-Gen CPU Architecture', 'High-Performance Memory Controller'],
			awards: ['AMD Engineering Excellence', 'Best Processor Design Innovation']
		}
	];
...
const ProgramPicturesCarousel = () => {
	...
	const programPictures = [
		...
		},
		{
			...
			image: '/events/img2.png',
			description: 'Celebrating the winning teams of our 48-hour electronics design challenge',
			date: 'February 2024',
			event: 'Competition'
		},
		{
		...
		},
		{
			...
			image: '/events/img2.png',
			description: 'Inter-college electronics circuit competition participants',
			date: 'November 2023',
			event: 'Competition'
		}
	];
...
// ECE Toppers Carousel Component
const ECEToppersCarousel = () => {
	const [currentSlide, setCurrentSlide] = useState(0);
	const [isHovered, setIsHovered] = useState(false);
	...
	const alumniTestimonials = [
		{
			...
			testimonial: "I am incredibly grateful for the education and experiences I gained at BPIT's ECE department. The rigorous curriculum, dedicated faculty, and numerous opportunities for hands-on learning in VLSI design and communication systems prepared me exceptionally well for my career in the semiconductor industry. The college's emphasis on both theoretical knowledge and practical circuit design gave me the confidence to tackle complex challenges in my role as a VLSI Design Engineer at Intel. The advanced labs and cutting-edge equipment at BPIT truly made a difference in shaping my professional journey. I would highly recommend BPIT ECE to anyone looking to build a strong foundation in electronics and communication engineering."
		},
		{
			name: "Tuhin Kalia",
			batch: "2019-23",
			company: "Qualcomm",
			role: "RF Engineer",
			testimonial: "My time at BPIT ECE was transformative in every sense. The college doesn't just focus on theoretical education but also nurtures practical skills in RF design and wireless communication. The faculty members are not only experts in their fields but also mentors who guide you beyond academics. The diverse project opportunities in antenna design and signal processing provided me with real-world exposure that proved invaluable during my transition to Qualcomm. The analytical and problem-solving skills I developed through circuit analysis and electromagnetic theory are what I use every day as an RF Engineer. BPIT ECE gave me the tools and confidence to pursue my dreams in the wireless technology world."
		},
		{
			name: "Neha Bedi",
			batch: "2018-22",
			...
			testimonial: "BPIT ECE has been instrumental in shaping my career and personal growth. The college provides an excellent blend of academic rigor and practical exposure through internships, projects, and industry partnerships in the semiconductor field. The faculty's commitment to student success is evident in their personalized attention and continuous support in complex topics like digital signal processing and microelectronics. The state-of-the-art VLSI labs and research opportunities allowed me to explore emerging technologies in chip design and develop innovative solutions. Today, as a Senior Hardware Engineer at Broadcom, I draw upon the strong foundation in electronics principles and the collaborative spirit I learned at BPIT ECE. I am proud to be an alumna of such a prestigious institution."
		}
	];
	...
	const getCurrentContent = () => {
						...
						<AnimatedCard delay={0.1}>
							<div className='bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200'>
								<div className='text-center mb-4'>
									...
									<p className='text-purple-600 font-medium text-sm'>HOD ECE</p>
								</div>
								...
								<div className='bg-white/70 rounded-lg p-4 space-y-3'>
									...
									<div className='flex items-start'>
										...
										<div>
											...
											<span className='text-gray-600 text-sm'>Ph.D(ECE), M.Tech (Electronics & Communication)</span>
										</div>
									</div>
						...
						<AnimatedCard delay={0.2}>
							<div className='bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200'>
								<div className='text-center mb-4'>
									...
									<p className='text-emerald-600 font-medium text-sm'>ECE Department</p>
								</div>
								...
								<div className='bg-white/70 rounded-lg p-4 space-y-3'>
									...
									<div className='flex items-start'>
										...
										<div>
											<span className='font-semibold text-gray-700 text-sm'>Research Interest: </span>
											<span className='text-gray-600 text-sm'>VLSI Design, Signal Processing, Communication Systems</span>
										</div>
									</div>
						...
						<AnimatedCard delay={0.3}>
							<div className='bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border border-purple-200'>
								<div className='text-center mb-4'>
									...
									<p className='text-pink-600 font-medium text-sm'>ECE Department</p>
								</div>
						...
						<AnimatedCard delay={0.4}>
							<div className='bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-4 border border-orange-200'>
								<div className='text-center mb-4'>
									...
									<p className='text-red-600 font-medium text-sm'>ECE Department</p>
								</div>
						...
						<AnimatedCard delay={0.5}>
							<div className='bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-4 border border-teal-200'>
								<div className='text-center mb-4'>
									...
									<p className='text-cyan-600 font-medium text-sm'>ECE Department</p>
								</div>
					...
					<AnimatedCard delay={0.5}>
						<div className='bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl p-6 border border-gray-200'>
							...
							<div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3'>
								{[
									"MATLAB", "Simulink", "Cadence", "Xilinx Vivado", "Verilog", "VHDL",
									"LabVIEW", "Multisim", "Proteus", "LTSpice", "HFSS", "CST Studio",
									"Arduino", "Raspberry Pi", "ARM Cortex", "DSP Processors", "FPGAs", "Microcontrollers",
									"RF Design", "Antenna Design", "PCB Design", "Signal Processing", "Communication Systems", "VLSI Design"
								].map((tech, index) => (
				...
				<div className='space-y-6'>
					...
					<AnimatedCard delay={0.1}>
						<div className='bg-gradient-to-br from-gray-50 to-purple-50 rounded-xl p-6'>
							...
							<div className='prose max-w-none text-gray-700 leading-relaxed'>
								<p className='text-base mb-4'>
									The Department of Electronics & Communication Engineering is committed towards excellence
									in education and research in the field of Electronics and Communication Engineering. The
									department offers a 4-year undergraduate program in Electronics & Communication Engineering
									leading to the degree of Bachelor of Technology.
								</p>
								<p className='text-base mb-4'>
									The Department has well-equipped laboratories, including VLSI Design Lab,
									Digital Signal Processing Lab, Communication Systems Lab, Microwave Engineering Lab,
									Embedded Systems Lab, and many more. The department also has a dedicated Research & Development center
									that focuses on cutting-edge research in various domains of electronics and communication.
								</p>
								<p className='text-base'>
									...
									latest technological trends in electronics and communication.
								</p>
							</div>
						</div>
					</AnimatedCard>
						...
						<div className='bg-white rounded-xl p-6 border border-gray-200'>
							...
							<div className='bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200'>
								<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-center'>
									<div className='lg:col-span-1'>
										<div className='relative'>
											<div className='w-32 h-32 bg-gradient-to-br from-purple-200 to-pink-200 rounded-xl mx-auto mb-4 flex items-center justify-center'>
											...
											<div className='text-center'>
												...
												<p className='text-gray-600 text-sm'>Ph.D. Electronics & Communication</p>
											</div>
										</div>
									</div>
									<div className='lg:col-span-3'>
										<div className='bg-white/70 backdrop-blur-sm rounded-xl p-4'>
											<p className='text-gray-700 italic mb-3 text-sm'>
												&quot;Welcome to the Department of Electronics & Communication Engineering. Our department
												is committed to providing quality education and fostering innovation in the
												field of electronics and communication technologies.&quot;
											</p>
											<p className='text-gray-700 italic mb-3 text-sm'>
												&quot;We strive to create an environment where students can develop their
												technical skills in VLSI design, digital signal processing, wireless communication,
												and embedded systems to become successful engineers and leaders in the ECE industry.&quot;
											</p>
		...
		if (activeSection === 'student-corner' && activeSubSection === 'awards') {
			...
			const awardsData: AwardsData = {
				'2024-25': [
					{ name: 'VIDHATRI NAUTIYAL', enrollment: '08220802723', class: 'ECE B', activity: 'college events like NSS', date: '20-02-2025', place: 'bpit', position: 'Appreciation/Participation Certificate' },
					{ name: 'Pulkit Arora', enrollment: '07820802723', class: 'ECE B', activity: 'Circuit Design Competition', date: '18-02-2025', place: 'Room 410', position: 'Appreciation/Participation Certificate' },
					{ name: 'Avikshit Trivedi', enrollment: '09920802723', class: 'ECE B', activity: 'Electronics Project Fair', date: '18-02-2025', place: 'Room no. 410', position: 'Appreciation/Participation Certificate' },
					{ name: 'Lakshay Joshi', enrollment: '07620802723', class: 'ECE B', activity: 'Communication Systems Quiz', date: '18-02-2025', place: '410', position: 'Appreciation/Participation Certificate' },
					{ name: 'Kusha Sharma', enrollment: '08120802723', class: 'ECE B', activity: 'VLSI Design Competition', date: '18-02-2025', place: 'room 410, bpit', position: 'Appreciation/Participation Certificate' },
